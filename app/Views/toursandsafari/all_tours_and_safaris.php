		...
		<div class="container">
			...
			<div class="row">
				...
				<div id="gallery" class="masonry gallery">
                    ...
                    <?php foreach($toursandsafari as $cat): ?>
					<!-- Start Gallery 01 -->
					<div data-filter="web" class="grid-item col-md-4 col-sm-6 col-xs-12">
						<div class="img-wrapper">
							<div class="img-caption capZoomInDown">
								<a href="<?= base_url('Tours_and_Safaris/tours_and_safaris_details')?>/<?php echo $cat['tours_and_safari_title']; ?>" class="zoomer ">
									<h4 ><?php echo $cat['tours_and_safari_title']; ?>
									</h4>
								</a>
							</div>
							<img src="<?= base_url('uploads/toursandsafariimages/'.$cat['tours_and_safari_image']) ?>" class="img-responsive" alt="" style="width:800px;height:200px;">
						</div>
                        <div class="img-content">
							<p class="text-left"><a href="<?= base_url('Tours_and_Safaris/tours_and_safaris_details')?>/<?php echo $cat['tours_and_safari_title']; ?>"><?php echo $cat['tours_and_safari_title']; ?></a></p>
