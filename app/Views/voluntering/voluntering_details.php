...
<!-- Mirrored from 99webpage.com/theme-review/html/anakual/singlepost-nosidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 Oct 2017 12:31:00 GMT -->
<head>
	<meta charset="utf-8">
    ...
    <title><?= $volunteering['volunteering_title']?></title>
...
<body>
	...
	<div class="contain-wrapp padding-bot60">	
		<div class="container">
					...
					<article class="post">
						<div class="media-wrapper">
							...
							<div class="flexslider">
								<ul class="slides">
									<li><img src="<?= base_url('uploads/volunteeringimages/'.$volunteering['volunteering_image']) ?>" alt="" style="height:400px"></li>
								
								</ul>
							</div>
							<!-- End Images slider -->
						</div>
            <h3 class="text-center" style="color:#062C17;"><?= $volunteering['volunteering_title']?></h3>
            ...
            <form method="post" id="destinations_form" enctype="multipart/form-data">
							<div class="modal-content">
								<div class="modal-header">
									...
									<h6 class="modal-title"><?= $volunteering['volunteering_title']?></h6>
								</div>
          ...
          <input type="hidden" name="enquire" id="enquire" value="<?= $volunteering['volunteering_title']?>" />
          ...
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
					...
					<!-- End modal -->
						         ...
						         <div style="background-color: #062C17;"><p ><?= $volunteering['volunteering_description']?></p>
    ...
    <!-- Flexslider -->
	<script src="<?= base_url()?>/sky/js/flexslider/jquery.flexslider-min.js"></script>
	<script src="<?= base_url()?>/sky/js/flexslider/setting.js"></script>
