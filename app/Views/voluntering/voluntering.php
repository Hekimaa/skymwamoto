					...
					<div data-filter="web" class="grid-item col-md-4 col-sm-6 col-xs-12">
						<div class="img-wrapper">
							<div class="img-caption capZoomInDown">
								<a href="<?= base_url('volunteering/single_volunteering')?>/<?php echo $cat['volunteering_title']; ?>" class="zoomer ">
									<h4 ><?php echo $cat['volunteering_title']; ?>
									</h4>
								</a>
							</div>
							<img src="<?= base_url('uploads/volunteeringimages/'.$cat['volunteering_image']) ?>" class="img-responsive" alt="" style="width:800px;height:200px;">
						</div>
                        <div class="img-content">
							<p class="text-left" ><a href="<?= base_url('volunteering/single_volunteering')?>/<?php echo $cat['volunteering_title']; ?>"><?php echo $cat['volunteering_title']; ?></a></p>
