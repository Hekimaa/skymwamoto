...
<head>
  ...
  <?php $i = 0;?>
                <?php if($mountaintrekkingdetails) { ?>
                <?php foreach($mountaintrekkingdetails as $cat): ?>
            <?php
                                          $i++;
						    	       if($i == 1)
						    	       break;
    ...
    <title><?php echo $cat->mountaintrekingroute_day; ?></title>
	...
	<div class="contain-wrapp padding-bot70">	
		<div class="container">
			<div class="row marginbot30">
				<div class="col-md-12">
                     ...
                     <!-- Start Images slider -->
							<div class="flexslider">
								<ul class="slides">
									<li><img style="width:900px; height: 400px;" src="<?= base_url('uploads/mountain_images/'.$cat->mountain_image) ?>" alt=""></li>
              ...
              <br>
              <br>
              <h3 class="text-center" style="color:#062C17;font-weight:300"><?php echo $cat->mountaintrekingroute_day; ?></h3>
      ...
      <button type="button" class="btn btn-primary" style="background-color: #062C17;" data-toggle="modal" data-target="#myModal">
            ...
            <form method="post" id="destinations_form" enctype="multipart/form-data">
							<div class="modal-content">
								<div class="modal-header">
									...
									<h6 class="modal-title"><?php echo $cat->mountaintrekingroute_day; ?></h6>
								</div>
          ...
          <input type="hidden" name="enquire" id="enquire" value="<?php echo $cat->mountaintrekingroute_day; ?>" />
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" id="heading1">
                                <h6 class="panel-title">
                                    ...
                                    <?php echo $cat->mountaintrekingroute_day; ?>
                                    </a>
                                </h6>
                            </div>
                            <div id="panel1" >
                                <div class="panel-body" style="background-color: #062C17;">
                                <?php echo $cat->mountaintrekingroute_description; ?>
                                </div>
                            </div>
                        </div>
                    </div>
