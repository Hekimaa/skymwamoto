...
<head>
    ...
    <title><?= $destination['destinations_title']?></title>
...
<body>
			...
			<div class="row marginbot30">
                ...
                <div class="media-wrapper">
							...
							<div class="flexslider">
								<ul class="slides">
									<li><img style="width:1000px; height: 450px;" src="<?= base_url('uploads/destinations_image/'.$destination['destinations_image']) ?>" alt=""></li>
                        ...
                        <br>
                        <br>
                        <h3 class="text-center" style="color:#062C17;font-weight:300"><?= $destination['destinations_title']?></h3>
            ...
            <form method="post" id="destinations_form" enctype="multipart/form-data">
							<div class="modal-content">
								<div class="modal-header">
									...
									<h6 class="modal-title"><?= $destination['destinations_title']?></h6>
								</div>
   ...
   <option value="Zimbabwe">Zimbabwe</option>
        ...
        <textarea placeholder="Additional information Which we should know?:" class="form-control" id="message" name="message"></textarea>
          ...
          <input type="hidden" name="enquire" id="enquire" value="<?= $destination['destinations_title']?>" />
          ...
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" id="heading1">
                                <h6 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion1" href="#panel1" >
                                        Description
                                    </a>
                                </h6>
                            </div>
                            <div id="panel1" class="panel-collapse collapse">
                                ...
                                <?= $destination['destinations_description']?>
                                </div>
                            </div>
                        </div>
                    </div>
			...
			<div class="row marginbot30">
				<div class="col-md-12">
					...
					<!-- Start Shortcode -->
                    <div class="panel-group margintop30" id="accordion2">
                        <div class="panel panel-default">
                            <div class="panel-heading" id="heading2">
                                <h6 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion2" href="#panel2" >
                                        Attractions
                                    </a>
                                </h6>
                            </div>
                            <div id="panel2" class="panel-collapse collapse">
                                <div class="panel-body" style="background-color: #062C17;">
                                <?= $destination['destinations_attractions']?>
                                </div>
                            </div>
                        </div>
                    </div>
			...
			<div class="row">
				<div class="col-md-12">
					<!-- Start Shortcode -->
                    <div class="panel-group margintop30" id="accordion3">
                        <div class="panel panel-default">
                            <div class="panel-heading" id="heading3">
                                <h6 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion3" href="#panel3" >
                                    When to go
                                    </a>
                                </h6>
                            </div>
                            <div id="panel3" class="panel-collapse collapse">
                                <div class="panel-body" style="background-color: #062C17;">
                                <?= $destination['destinations_whentogo']?>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
					<!-- Start Shortcode -->
                    <div class="panel-group margintop30" id="accordion4">
                        <div class="panel panel-default">
                            <div class="panel-heading" id="heading4">
                                <h6 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion4" href="#panel4" >
                                    Location
                                    </a>
                                </h6>
                            </div>
                            <div id="panel4" class="panel-collapse collapse">
                                <div class="panel-body" style="background-color: #062C17;">
                                <?= $destination['destinations_location']?>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
					<!-- Start Shortcode -->
                    <div class="panel-group margintop30" id="accordion5">
                        <div class="panel panel-default">
                            <div class="panel-heading" id="heading5">
                                <h6 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion5" href="#panel5" >
                                    Where to Stay
                                    </a>
                                </h6>
                            </div>
                            <div id="panel5" class="panel-collapse collapse">
                                <div class="panel-body" style="background-color: #062C17;">
                                <p style="color:white;">There are variety of places such as hotels,lodges,camps,cortage and bandas and also depends on your budget there luxury,mid range and budget we have alot of options for our tourist and </p>
                                </div>
                            </div>
                        </div>
                    </div>
