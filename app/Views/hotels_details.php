...
<head>
    ...
    <title>SKYMWAMOTO | Hotels Details.</title>
...
<body class="datepicker_mobile_full"><!-- Remove this class to disable datepicker full on mobile -->
	...
	<main>
		...
		<section class="hero_in general">
			<div class="wrapper" style="background-repeat:no-repeat;background-size:cover;background-image: url(<?= base_url('uploads/hotels_image/'.$hotelsdetails['hotels_image']) ?>">
				<div class="container">
					<h1 class="fadeInUp"><?= $hotelsdetails['hotels_title']?></h1>
			...
			<div class="container margin_60_35">
				<div class="row">
					<div class="col-lg-8">
                        ...
                        <h3>Pictures from our users</h3>
							<div class="pictures_grid magnific-gallery clearfix">
							    <figure><a href="<?= base_url('uploads/hotels_image/'.$hotelsdetails['hotels_image']) ?>" title="Photo title" data-effect="mfp-zoom-in"><img src="<?= base_url('uploads/hotels_image/'.$hotelsdetails['hotels_image']) ?>" alt=""></a></figure>
							...
							<p><?= $hotelsdetails['hotels_description']?></p>
					...
					<aside class="col-lg-4" id="sidebar">
						<div id="enquire" class="text-center">
			
	            </div>
						<div class="box_detail booking">
							<div class="price text-center">
								
								<button type="button" class="btn btn-primary btn-lg" data-toggle="modal" id="addDestinations" name="addDestinations">
								 Enquire Now
								</button>
	...
	<!-- Modal -->
<div class="modal fade" id="destinationenquire" tabindex="-1" role="dialog" aria-labelledby="destinationenquire" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable" role="document">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
         ...
         <h5 class="modal-title text-center" id="destinationenquire"><?= $hotelsdetails['hotels_title']?></h5>
      <div class="modal-body">
	   ...
	   <div class="col-sm-12">
		...
		<div class="form-group">
		   ...
		   <input type="integer" name="phonenumber" id="email" class="form-control" />
   ...
   <option value="Zimbabwe">Zimbabwe</option>
		...
		<div class="form-group">
	     ...
	     <div class="form-group">
            <label for="message-text" rows="4" id="message" name="message" class="col-form-label">
              Additional information Which we should know?:</label>
            <textarea class="form-control" id="message" name="message"></textarea>
             <span id="message_error" class="text-danger"></span>
          </div>
      </div>
      <div class="modal-footer">
          <input type="hidden" name="enquire" id="enquire" value="<?= $hotelsdetails['hotels_title']?>" />
	...
	<script src="<?= base_url()?>/skytour/js/map_single_hotel.js"></script>
